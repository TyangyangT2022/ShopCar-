...
public class ShopCarTest {
    ...
    public static void pay(Goods[] shopCar) {
        ...
        for (int i = 0; i < shopCar.length; i++) {
            ...
            meany += g.getPrice() * g.getBuyNumber();
        }
    ...
    public static void updateGoodsPrice(Goods[] shopCar, Scanner sc, int location,int id) {
        ...
        shopCar[location].setPrice(sc.nextDouble());
        System.out.println("\n\n");
        Tips1();
        Tips2();
    }
    ...
    public static void Tips3(Goods[] shopCar, int location, int id) {
        try {
            ...
            System.out.println("商品名称:" + shopCar[location].getName());
            System.out.println("商品价格:" + shopCar[location].getPrice());
            System.out.println("商品数量:" + shopCar[location].getBuyNumber() + "\n");
    ...
    public static void updateGoodsName(Goods[] shopCar, Scanner sc, int location,int id) {
        ...
        shopCar[location].setName(sc.next());
        System.out.println("\n\n");
        Tips1();
        Tips2();
    }
    ...
    public static void DeleteGoods(Goods[] shopCar,int location,int id,Scanner sc) {
        ...
        if (shopCar[location] == null) {
            System.out.println("删除编号" + id + "完成！！");
        } else if (shopCar[location] != null) {
            System.out.println("删除编号" + id + "失败!!!");
        }
    ...
    public static void updateGoodsBuyNumber(Goods[] shopCar,int location,int id,Scanner sc) {
        ...
        shopCar[location].setBuyNumber(sc.nextInt());
        System.out.println("\n\n");
        Tips1();
        Tips2();
    }
